...
_PIPE_TO_SHELL = r"https?://.*\|\s*(bash|sh|zsh|python|powershell|pwsh)"
PIPE_TO_SHELL_RE = re.compile(r"(?is)" + _PIPE_TO_SHELL)
REMOTE_BOOTSTRAP_RE = re.compile(r"(?is)(curl|wget|invoke-webrequest|iwr|irm)\b.*https?://|" + _PIPE_TO_SHELL)
