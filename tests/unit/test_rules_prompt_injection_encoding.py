...
while legitimate data URIs are excluded.
"""
...
class TestPI006SteganographicEncoding:
    ...
    @pytest.mark.parametrize(
        ...
        [
            "aWdub3Jl",
            "A" * 100,
            "QmFzZTY0RW5jb2RlZFBheWxvYWQ=" * 4,
            "VGhpc0lzQVZlcnlMb25nQmFzZTY0U3RyaW5n" * 4,
        ],
    )
    ...
    def test_pi006_allows_short_base64_strings(self, pi_rules: list[Rule]) -> None:
        ...
        # Short base64 strings (< 100 chars) should not trigger long encoding pattern
    ...
    def test_pi006_detects_hex_escape_sequences(self, pi_rules: list[Rule]) -> None:
        ...
        # Four or more consecutive \xNN hex escapes should trigger detection
